...
export const BLOCK_LAVA = 8;
export const BLOCK_COAL_ORE = 9;
export const BLOCK_IRON_ORE = 10;
export const BLOCK_GOLD_ORE = 11;
export const BLOCK_DIAMOND_ORE = 12;
export const BLOCK_PLANKS = 13;
export const BLOCK_COBBLESTONE = 14;
export const BLOCK_GLASS = 15;
export const BLOCK_BEDROCK = 16;
export const BLOCK_GRAVEL = 17;
export const BLOCK_SNOW = 18;

export const Blocks = {
  [BLOCK_AIR]:          { name: 'Air',          solid: false, transparent: true,  hardness: 0,   color: { top: null, side: null, bottom: null } },
  [BLOCK_GRASS]:        { name: 'Grass',         solid: true,  transparent: false, hardness: 0.6, color: { top: '#5a9e3a', side: '#8B6343', bottom: '#8B6343' } },
  ...
  [BLOCK_WOOD]:         { name: 'Oak Log',       solid: true,  transparent: false, hardness: 2.0, color: { top: '#c8a96a', side: '#7a5c2e', bottom: '#c8a96a' } },
  [BLOCK_LEAVES]:       { name: 'Leaves',        solid: true,  transparent: true,  hardness: 0.2, color: { top: '#3a8a28', side: '#3a8a28', bottom: '#3a8a28' } },
  ...
  [BLOCK_COAL_ORE]:     { name: 'Coal Ore',      solid: true,  transparent: false, hardness: 3.0, color: { top: '#6e6e6e', side: '#6e6e6e', bottom: '#6e6e6e' } },
  [BLOCK_IRON_ORE]:     { name: 'Iron Ore',      solid: true,  transparent: false, hardness: 3.0, color: { top: '#a97c50', side: '#a97c50', bottom: '#a97c50' } },
  [BLOCK_GOLD_ORE]:     { name: 'Gold Ore',      solid: true,  transparent: false, hardness: 3.0, color: { top: '#f1c40f', side: '#d4ac0d', bottom: '#d4ac0d' } },
  [BLOCK_DIAMOND_ORE]:  { name: 'Diamond Ore',   solid: true,  transparent: false, hardness: 5.0, color: { top: '#5dade2', side: '#5dade2', bottom: '#5dade2' } },
  [BLOCK_PLANKS]:       { name: 'Oak Planks',    solid: true,  transparent: false, hardness: 2.0, color: { top: '#c8a96a', side: '#c8a96a', bottom: '#c8a96a' } },
  ...
  [BLOCK_SNOW]:         { name: 'Snow',          solid: true,  transparent: false, hardness: 0.1, color: { top: '#f0f4f8', side: '#e8ecef', bottom: '#dde1e5' } },
};
